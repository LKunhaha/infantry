...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, IST_INT_Pin|IST_RET_Pin|LED_Red_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOG, LASTER_Pin|LED8_Pin|LED7_Pin|LED6_Pin 
                          |LED5_Pin|LED4_Pin|LED3_Pin|LED2_Pin 
                          |LED1_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, Power_1_Pin|Power_2_Pin|Power_3_Pin|Power_4_Pin 
  ...
  GPIO_InitStruct.Pin = IST_INT_Pin|IST_RET_Pin;
  ...
  /*Configure GPIO pins : PGPin PGPin PGPin PGPin 
                           ...
                           PGPin */
  GPIO_InitStruct.Pin = LASTER_Pin|LED8_Pin|LED7_Pin|LED6_Pin 
                          |LED5_Pin|LED4_Pin|LED3_Pin|LED2_Pin 
                          |LED1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
